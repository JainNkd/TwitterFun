...
- (void)viewDidLoad {
    ...
    [self refreshTwitterFollowerListWithCompletion];
...
- (void)refreshTwitterFollowerListWithCompletion{
            ...
            if (accounts.count > 0)
            {
                ...
                [request performRequestWithHandler:^(NSData *responseData,
                    ...
                    else
                    {
                        ...
                        {
                            NSLog(@"follower responseJSON..%@",(NSDictionary*)responseJSON.description);
